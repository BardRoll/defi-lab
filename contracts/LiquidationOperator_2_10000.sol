...
contract LiquidationOperator_2_10000 is IUniswapV2Callee {
    ...
    constructor() {
        ...
        //จำนวน USDT ที่จะกู้จาก Flash Loan
    ...
    function uniswapV2Call(
        ...
        console.log("-------------------");
        console.log("2.0 security checks and initializing variables");
        ...
        // นำ 10,000 USDT ไป liquidate target user ที่มี WBTC เป็น collateral

        console.log("-------------------");
        console.log("2.1 liquidate the target user");
        ...
        console.log("get WBTC:", WBTC.balanceOf(address(this)));

        // 2.2 repay
        // นำ WBTC ที่ได้จากข้อ 2.1 มาใช้หนี้ flash loan

        console.log("-------------------");
        console.log("2.2 repay");
        ...
        uint WBTC_balance = WBTC.balanceOf(address(this));

        console.log("repay WBTC: %s", repay_WBTC);
        console.log("WBTC balance: %s", WBTC_balance);
        
        // 2.3 swap WBTC for WETH
        // นำ WBTC ที่เหลือจากข้อ 2.2 มาแลกเป็น WETH

        console.log("-------------------");
        console.log("2.3 swap WBTC for WETH");

        WBTC.transfer(address(uniswapV2Pair_WBTC_WETH), WBTC_balance);
        uint amountOut_WETH = getAmountOut(WBTC_balance, reserve_WBTC_Pool2, reserve_WETH_Pool2);
        uniswapV2Pair_WBTC_WETH.swap(0, amountOut_WETH, address(this), "");

        console.log("amount out WETH: %s", amountOut_WETH);
        console.log("-------------------");
