...
contract LiquidationOperator_3 is IUniswapV2Callee {
    ...
    constructor() {
        ...
        debt_USDC = 8128956343; // จำนวน USDC จาก etherscan (8,128.956343)
    ...
    function uniswapV2Call(
        ...
        // นำ USDC ไป liquidate target user ที่มี WETH เป็น collateral
        ...
        console.log("get WETH:", WETH.balanceOf(address(this)));

        // 2.2 repay
        // นำ WETH ที่ได้จากข้อ 2.1 มาใช้หนี้ flash loan
